...
function App() {
  return (
    ...
    <div className={style.cardContainer}> {/* Flex container */}
    <div className={style.card}>
      ...
      <button onClick={Click}>Click Me to known more</button>  {/* Use handleClick here */}
    </div>
    </div>
    <div className={`${style.card} ${style.supermanCard}`}>
         <img src={profile1} alt="My profile pic" width="45px" height="50px" />
         <h3>SUPERMAN</h3>
         <p >Superman, born Kal-El, is from the fictional planet Krypton. His parents, Jor-El and Lara, sent him to Earth in a small spaceship just before Krypton's destruction. The ship landed near Smallville, Kansas, where farmers Jonathan and Martha Kent found and adopted him, naming him Clark Kent.</p>
         <div className={style.button}>
         <button onClick={handleSupermanClick}>Click Me to know more</button> {/* Use handleSupermanClick here */}
         </div>
    </div>
    <div className={`${style.card} ${style.flashCard}`}>
         ...
         <div className={style.button}>
         <button onClick={handleflashClick}>Click Me to know more</button> {/* Use handleSupermanClick here */}
         </div>
    </div>
  </div>
